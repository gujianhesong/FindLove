...
public class SourceContentView extends BaseContentView {

  private ArrayList<OCResultBean.Source> mDatas;

  private OCResultBean mOCResultBean;

  public SourceContentView(Context context) {
    super(context);
  ...
  @Override public void fillData(OCResultBean bean) {
    ...
    if (mOCResultBean != null && mOCResultBean.sourceList != null) {
      mDatas.addAll(mOCResultBean.sourceList);
    }
