...
public class ViewPagerTabStrip extends LinearLayout {
    ...
    public ViewPagerTabStrip(Context context, AttributeSet attrs) {
        ...
        mSelectedUnderlineThickness = res
                .getDimensionPixelSize(R.dimen.PaddingTwo);
        int underlineColor = ResourcesCompat.getColor(res, android.R.color.white, null);
        int backgroundColor = ResourcesCompat.getColor(res, R.color.accent_material_light, null);
